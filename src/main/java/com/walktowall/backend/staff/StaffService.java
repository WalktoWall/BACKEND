...
public class StaffService {
    ...
    private String generateStaffGuidance(VisitCard visitCard) {
        ...
        String prompt = String.format(
                ...
                세번째 문장은 단순히 ‘편하게 둘러보세요’ 수준을 넘어서, 직원다운 전문성과 세심한 배려가 느껴지도록 작성한다. 고객이 프리미엄 서비스를 받고 있다는 인상을 줄 수 있도록 구체적이고 신뢰감 있는 첫 응대 멘트를 제시하라.
                응대 멘트는 직원이 고객의 무드와 쇼핑 목적을 존중한다는 뉘앙스를 담고, 필요 시 맞춤 안내를 제공할 준비가 되어 있다는 점을 자연스럽게 드러내야 한다.
                세번째 응대 추천 문장에선 고객의 Visit Card를 통한 정보를 먼저 자연스럽게 말하며 공손하게 시작한다.
                visit card 내부에 답이 있는 정보를 물어보지 않는다.
                
                고객이 온 첫 순간 첫 응대에 직원에게 도움을 준다는 목적을 잊지 마라.
                ...
                ex) 안녕하세요, 고객님께서 원하시는 분위기를 존중해 드리며 편히 둘러보실 수 있도록 준비해 두었습니다. 혹시 소재나 디자인에 대해 더 깊이 확인하고 싶으실 때 말씀 주시면, 바로 맞춤 안내를 드리겠습니다.
                ...
                - 실제 MCM 매장 직원이 고객 응대에 사용할 수 있을 정도로 자연스럽게 작성하라.
                - 고객이 아닌 **직원용**이라는 것을 명심해서 작성하라. 직원의 응대에 도움을 줄 수 있어야한다.
                - 함께 탐구하자는 듯한 만화 대사 같은 의무문은 사용하지 마라. 실제 응대에 나올 정도의 의무문만 사용한다.
                - 도움을 준다는 뉘앙스를 붙여도 좋다.
                - 직원이 실제 매장에 들어온 손님에게 **응대**할 때 사용하는 문장이라는 걸 잊지 마라.
                - 세 번째 문장은 예시를 참고해라. 따라하지 말고 참고 정도만 한다.
